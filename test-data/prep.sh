...
curl https://repo1.maven.org/maven2/org/sonatype/maven-policy-demo/1.2.0/maven-policy-demo-1.2.0.jar --output test-artefacts/maven-policy-demo-1.2.0.jar
curl https://repo1.maven.org/maven2/org/sonatype/maven-policy-demo/1.3.0/maven-policy-demo-1.3.0.jar --output test-artefacts/maven-policy-demo-1.3.0.jar
