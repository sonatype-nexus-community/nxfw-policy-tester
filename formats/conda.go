...
func (c CondaFormat) GetPackages() []Package {
	...
	return []Package{
		{Name: "gettext", Version: "0.19.8.1", SecurityLevel: SecurityCritical, Extension: "tar.bz2", Qualifier: "main/linux-64/h9b4dc7a_1"},
		{Name: "setuptools", Version: "61.2.0", SecurityLevel: SecurityHigh, Extension: "tar.bz2", Qualifier: "main/linux-64/py310h06a4308_0"},
		{Name: "gettext", Version: "0.21.0", SecurityLevel: SecurityLow, Extension: "tar.bz2", Qualifier: "main/linux-64/h7535e17_0"},
	}
}
